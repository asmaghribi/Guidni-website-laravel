    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
        <div class="avatar avatar-online">
            ...
            <img src="{{ asset(auth::guard('admin')->user()->avatar) }}" alt class="w-px-40 h-auto rounded-circle" style="max-height: 44px !important"/>
          ...
          <a class="dropdown-item" href="">
            <div class="d-flex">
              <div class="flex-shrink-0 me-3">
                <div class="avatar avatar-online">
                    @if(auth::guard('admin')->user()->avatar )
                    <img src="{{ asset(auth::guard('admin')->user()->avatar) }}"  class="w-px-40 h-auto rounded-circle" style="max-height: 44px !important"/>
