        ...
        <div class="card">
            <div class="row justify-content-between">
                ...
                <div class="col-auto mt-2">
                    <a href="{{ route('supplier.restaurants.create') }}" class="btn btn-primary me-2"><i class="bx bx-plus"></i> Nouveau</a>
                </div>
            </div>
                ...
                <table class="table ">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-warning" title="edit"  href="{{ route('supplier.restaurants.edit',$restaurant->id) }}"> <i class="bx bx-edit text-white"></i></a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form  method="POST" action="{{ route('supplier.restaurants.delete',$restaurant->id) }}">
                                                    @csrf
                                                    @method('Delete')
